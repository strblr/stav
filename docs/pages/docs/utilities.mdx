...
This is mainly used by Stav internally. For example, it is used to avoid middlewares from running their side-effects on their own updates, avoiding infinite loops.
